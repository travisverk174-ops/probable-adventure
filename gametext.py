...
def garden_left1():
    segment = '+5 Damage'
    a = (Fore.RED + f"Mario stepped into the glasshouse.\n\
...
def garden_left2():
       a = (Fore.RED + f"He stepped back through the cracked doorway, leaving behind the jungle of alien flora.\n\
...
def prison_pharmacy2():
    a = (Fore.RED + f"Mario stepped out of the treatment room, the mushroom’s warmth still pulsing through him.\n\
